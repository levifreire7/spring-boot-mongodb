...
import com.levifreire.springbootmongodb.dto.AuthorDTO;
import com.levifreire.springbootmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar para São Paulo. Abraćos!",
				new AuthorDTO(maria));
